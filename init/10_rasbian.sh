...
sudo apt-get install git-core git-gui tree nmap htop tmux mdadm lvm2 vim arduino obconf libjpeg-dev libv4l-dev autoconf automake android-tools-adb uv4l uv4l-raspicam uv4l-raspicam-extras uv4l-webrtc iceweasel autossh screen exfat-fuse exfat-utils meld jq
